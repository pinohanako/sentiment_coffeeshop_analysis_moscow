...
Проект включает визуализации для анализа количественных и текстовых переменных. Составлены облака слов, проанализированы такие метрики, как SOV (Share of Voice) и NPS (Net Promoter Score), чтобы оценить лояльность и удовлетворенность клиентов.
...
### **Prime**:
Посетителей особенно привлекают **доступные цены** и **блюда национальной кухни**. 
...
— Проблемы с качеством продуктов требуют немедленного внимания: клиенты время от времени негативно оценивают свежесть и качество
